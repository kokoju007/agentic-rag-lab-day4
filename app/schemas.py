...
class AskResponse(BaseModel):
    ...
    debug_guardrail_blocked: bool = Field(
        default=False,
        description="Debug guardrail blocked state.",
    )
    debug_guardrail_raw: dict | None = Field(
        default=None,
        description="Raw guardrail payload for debugging.",
    )
    debug_guardrail_literal: dict | None = Field(
        default=None,
        description="Guardrail payload for literal test.",
    )
